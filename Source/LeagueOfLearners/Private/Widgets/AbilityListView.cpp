...
void UAbilityListView::ConfigureAbilities(const TMap<ELOLAbilityInputID, TSubclassOf<class UGameplayAbility>>& Abilities) {
	OnEntryWidgetGenerated().AddUObject(this,&UAbilityListView::AbilityGaugeGenerated);
	for (const TPair< ELOLAbilityInputID, TSubclassOf<class UGameplayAbility>>& AbilityPair : Abilities) {
